...
- 第 2 章：数据来源与预处理。
- 第 3 章中关于时间、节假日、天气和结构特征说明。
- 附录中的数据字段说明和运行流程。

GitHub 提交记录：

- `Initial Commit`
- `feat(data): add data and processing methods`
- `Update`
...
- `feat(dashboard): build Streamlit analysis dashboard`
- `feat(reporting): export report tables and figures`
- `docs(project): add run guide contribution and team handoff notes`
- `docs(poster): add final A1 porject poster`
